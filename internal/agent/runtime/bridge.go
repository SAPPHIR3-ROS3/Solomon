...
func (h turnHost) WaitProviderReady(ctx context.Context) error { return h.Runtime.waitProviderReady(ctx) }
...
func (h turnHost) SystemPrompt(disableThinking bool) (string, error)    { return h.Runtime.systemPrompt(disableThinking) }
...
func (h turnHost) AllowedToolNames() (map[string]struct{}, error) { return h.Runtime.allowedToolNames() }
...
func (h turnHost) HandleRejectedNativeToolCall() error { return h.Runtime.handleRejectedNativeToolCall() }
...
func (h turnHost) HandleProxyToolCorrection(msg string) error  { return h.Runtime.handleProxyToolCorrection(msg) }
