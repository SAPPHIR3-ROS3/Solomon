...
type WailsDesktopBridge = {
  ...
  HomeDirectoryBranches?: (relativePath: string) => Promise<unknown>;
  HomeDirectoryWorktrees?: (relativePath: string) => Promise<unknown>;
  CheckoutHomeDirectoryBranch?: (relativePath: string, branch: string) => Promise<unknown>;
  ...
  SaveFastMode?: (enabled: boolean) => Promise<boolean>;
