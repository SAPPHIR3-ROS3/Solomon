...
| **Component** | Slash handlers, editor keys, completion | [`testDeps`](../../test/helpers_test.go), [`*ForTest`](../../internal/agent/runtime/repl/editor_testexport.go) |
...
| `NewMultilineEditorForTest` | [`editor_testexport.go`](../../internal/agent/runtime/repl/editor_testexport.go) | Editor buffer, keys, completion without a terminal |
...
When REPL behavior needs new assertions, add **`ForTest` exports** in `editor_testexport.go` rather than exporting production APIs.
