...
## 1 — Font e colori (terminale robusto)
...
## 2 — Byte truncation (limiti output)
...
## 3 — Integrazione `AGENTS.md` / `CLAUDE.md` (istruzioni progetto)
...
## 8 — Syntax highlighting nel terminale
...
## 9 — Pattern immagini rafforzato (caratteri invisibili)
...
## 16 — Vault sicuro (informazioni sensibili)
...
## 17 — Autenticazione verso i major lab
...
## 19 — Memoria (MemPalace) e Obsidian
