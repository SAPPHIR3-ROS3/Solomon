...
## 1 — Byte truncation (limiti output)
...
## 2 — Integrazione `AGENTS.md` / `CLAUDE.md` (istruzioni progetto)
...
## 7 — Syntax highlighting nel terminale
...
## 8 — Pattern immagini rafforzato (caratteri invisibili)
...
## 15 — Vault sicuro (informazioni sensibili)
...
## 16 — Autenticazione verso i major lab
...
## 18 — Memoria (MemPalace) e Obsidian
